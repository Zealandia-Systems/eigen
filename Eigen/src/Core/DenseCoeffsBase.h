...
class DenseCoeffsBase<Derived, ReadOnlyAccessors> : public EigenBase<Derived> {
 public:
  ...
  EIGEN_DEVICE_FUNC
  EIGEN_STRONG_INLINE CoeffReturnType a() const {
    EIGEN_STATIC_ASSERT(Derived::SizeAtCompileTime == -1 || Derived::SizeAtCompileTime >= 4, OUT_OF_RANGE_ACCESS);
    return (*this)[3];
  }

  /** equivalent to operator[](4).  */

  EIGEN_DEVICE_FUNC
  EIGEN_STRONG_INLINE CoeffReturnType b() const {
    EIGEN_STATIC_ASSERT(Derived::SizeAtCompileTime == -1 || Derived::SizeAtCompileTime >= 5, OUT_OF_RANGE_ACCESS);
    return (*this)[4];
  }

  /** equivalent to operator[](5).  */

  EIGEN_DEVICE_FUNC
  EIGEN_STRONG_INLINE CoeffReturnType c() const {
    EIGEN_STATIC_ASSERT(Derived::SizeAtCompileTime == -1 || Derived::SizeAtCompileTime >= 6, OUT_OF_RANGE_ACCESS);
    return (*this)[5];
  }
